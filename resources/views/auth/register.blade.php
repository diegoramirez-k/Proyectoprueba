            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="telefono" class="col-md-4 col-form-label text-md-center">{{ __('Telefono') }}</label>
                        ...
                        @can('supervisor')
                        <div class="form-group row">
                            <label for="rol" class="col-md-4 col-form-label text-md-center">{{ __('Rol') }}</label>
